...
class MakeOrderList extends StatelessWidget {
  const MakeOrderList({Key key, @required List<Order> makeorder})
      : _makeorder = makeorder,
        super(key: key);
  final List<Order> _makeorder;
  @override
