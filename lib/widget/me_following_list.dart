...
class MeFollowingList extends StatefulWidget {
  @override
  _MeFollowingListState createState() => _MeFollowingListState();
}

class _MeFollowingListState extends State<MeFollowingList> {
  var isFollow = false;
